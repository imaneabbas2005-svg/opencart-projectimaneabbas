        ...
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
              ...
              <!-- NEW: Cost Filter -->
              <td align="left"><input type="text" name="filter_cost" value="<?php echo $filter_cost; ?>" size="8" 
                     placeholder=">100, <=50, !=0" title="Supports: >, <, >=, <=, !=" /></td>
              <!-- NEW: Profit Filter -->
              <td align="left"><input type="text" name="filter_profit" value="<?php echo $filter_profit; ?>" size="8" 
                     placeholder=">20, <100, !=0" title="Supports: >, <, >=, <=, !=" /></td>
              <!-- NEW: Category Path Filter -->
              <td align="left">
                <select name="filter_category_path">
                  <option value=""></option>
                  <?php foreach ($categories as $category) { ?>
                  <option value="<?php echo $category['category_id']; ?>" 
                    <?php echo ($filter_category_path == $category['category_id']) ? 'selected="selected"' : ''; ?>>
...
function filter() {
	...
	// NEW: Category path filter
	var filter_category_path = $('select[name=\'filter_category_path\']').attr('value');
